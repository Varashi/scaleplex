...
func TestCrossBackend_VAAPI_to_NVIDIA_noSub(t *testing.T) {
	...
	if !containsString(out.Changes, "cross-backend:vaapi->nvidia") {
...
func TestCrossBackend_VAAPI_HDR_to_NVIDIA(t *testing.T) {
	...
	out := Rewrite(args, nil, nil)
	if !out.Applied || !containsString(out.Changes, "cross-backend:vaapi->nvidia") {
...
func TestCrossBackend_NativeIsNoOp(t *testing.T) {
	...
	out := Rewrite(args, nil, nil)
	if containsString(out.Changes, "cross-backend:vaapi->nvidia") || containsString(out.Changes, "cross-backend:nvenc->nvidia") {
